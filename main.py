...
def time_interval():
    ...
    clock.after(200, time_interval)
def contact_us():
    mess._show(title='Contact us', message="Please contact us on : '0107aniket@gmail.com' ")
...
message3 = tk.Label(window, text="Smart Attendance Management System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
